...
public class Recognize {
  ...
  public static void main(String... args) throws Exception {
    ...
    if (command.equals("syncrecognize")) {
      ...
      ArduinoConnectBluetoothNew.connect();
      try (Scanner input = new Scanner(System.in)){
        while (true) {
          System.out.print("Input any character to continue and \"q\" to exit: ");
        ...
        ArduinoConnectBluetoothNew.disconnect();
      }
  ...
  public static void streamingMicRecognize1() throws Exception {


    for (int i = 1 ; i<100; i++){
      System.out.println(Math.random());
    }
    //URL url = Recognize.class.getResource("output.mp3");
    //InputStream stream = new FileInputStream("output.mp3");
    //Player player = new Player(stream);
  //player.play();
  // ArduinoConnectBluetooth ac = new ArduinoConnectBluetooth();
   //ac.Send();
 //   ArduinoConnect ac = new ArduinoConnect();
   // ac.Send();
  }
      ...
      responseObserver =
          new ResponseObserver<StreamingRecognizeResponse>() {
            ...
            public void onComplete() {
              ...
              try {
                String response = ChatGPT.connectToGPT(transcript);
